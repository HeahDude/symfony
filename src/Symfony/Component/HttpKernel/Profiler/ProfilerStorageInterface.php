...
interface ProfilerStorageInterface
{
     ...
     * @param string|null $excludeMethod
     */
    public function find(?string $ip, ?string $url, ?int $limit, ?string $method, int $start = null, int $end = null,/* string $excludeMethod = null */): array;
